 ...
 * wifi_rogueap_task()
 * 
 * @brief: Background task that handles rogueAP.
 **/

void wifi_rogueap_task(void *parameter)
{
...
void wifi_rogueap_enable(void)
{
  ...
  /* Start scanner. */
  xTaskCreate(wifi_rogueap_task, "wifi_rogueap", 10000, NULL, 1, &g_wifi_ctrl.current_task_handle);
}
